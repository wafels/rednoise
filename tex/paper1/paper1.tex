...
{\bf However, two recent papers cast doubt on this assumption.
  ...
  active regions and the quiet Sun as seen in the 19.5 nm passband
  ...
  points in AIA 171 coronal plumes extending over the frequency range
  $0.3\rightarrow 4.0$ mHz.}  {\bf The aim of this paper is to
  investigate the nature of the Fourier power spectrum in regions of
  interest to coronal seismology, to look for evidence that the above
  assumption is appropriate.  Data from the Atmospheric Imaging
  Assembly (AIA, \citealp{2012SoPh..275...17L}) on board the Solar
  Dynamics Observatory (SDO, \citealp{2012SoPh..275....3P}) is used.
  It is shown that time-series of coronal emission have power-law
  power spectra, at least approximately.}  The \PL\ \PS\ nature of
coronal emission has implications for coronal seismology, and may be
...
different temperature ranges, and may be imaging {\bf different parts
  ...
  locations).}  Hence, the emission seen in one waveband need not have
...
locations on and off the disk. {\bf Automated definitions of coronal
  ...
  temperature ranges in the solar corona.}  The power-law index in
...
a better understanding of the source of the power-law power spectrum
