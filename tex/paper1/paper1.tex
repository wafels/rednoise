...
\begin{abstract}
  ...
  AIA 171\AA\ and 193\AA\ data.  It is commonly assumed that coronal
  time-series are well described by the sum of a long time-scale
  background trend plus Gaussian-distributed noise, with some specific
  locations also showing an oscillatory signal.  It is shown that the
  \mFpa\ in all regions follows an approximate \PL\ behaviour.  This
  average behavior is inconsistent with this commonly held assumption.
  The implications of this discovery to the field of coronal
...
by SOHO/EIT \citep{1998ApJ...501L.217D, 1999SoPh..186..207B} and TRACE
