...
\tabletypesize{\scriptsize}
\tablecaption{Number of pixels and effectively independent pixels as a function of region and waveband, as calculated following the procedure of Section \ref{sec:app:ind}. \label{tab:neff}}
\tablewidth{0pt}
\tablehead{
\colhead{Region} &
\colhead{$N_{pixel}$} &
