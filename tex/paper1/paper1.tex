...
frequencies than those considered here. \cite{2014AA...563A...8A}
integrate emission over small portions of active regions and the quiet
Sun as seen in the 19.5 nm passband image from the of the SOHO
\cite{1995SoPh..162....1D} Extreme ultraviolet Imaging Telescope (EIT;
\cite{1995SoPh..162..291D}) and show that the resulting time-series
has an approximate \PL\ \Fps.  The frequency range covered by their
study is approximately 0.01 - 1 mHz.
