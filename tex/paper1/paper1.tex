...
Figures \ref{fig:demo171} and \ref{fig:demo193} show example power
spectra, plotted using a log-log scale from individual pixels inside
each of the regions shown in Figures \ref{fig:loc171} and
\ref{fig:loc193}.  The shape of the power spectra indicate that the
Fourier power follows a power law approximately.
...
\caption{Log-log plot of the Fourier power of a time-series at the AIA
  ...
  considered (Figure \protect\ref{fig:loc171}).  The vertical black lines
  indicate the 3 and 5 minute frequencies. The equivalent plot in the
  AIA 193\AA\ waveband is shown in Figure \protect\ref{fig:demo193}.}
\end{figure}
...
\caption{Log-log plot of the Fourier power of a time-series at the AIA
  pixel overlying a randomly chosen pixel in each of the regions
  considered (Figure \protect\ref{fig:loc193}).  The vertical black lines
  indicate the 3 and 5 minute frequencies. The equivalent plot in the
  AIA 171\AA\ waveband is shown in Figure \protect\ref{fig:demo171}.}
\end{figure}
...
\begin{equation}
\label{eq:pwrlawbunp}
\ln P_{1}(f) = P_{0} + \alpha\exp\left[-\frac{(\ln(f)-\beta)^{2}}{2\sigma^{2}}
\end{equation}
