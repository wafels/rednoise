...
and at least approximately Gaussian-distributed noise.  {\bf The aim
  of this paper is to investigate the nature of the Fourier power
  spectrum in regions of interest to study of the coronal seismology,
  thereby testing the assumption above}.  It is shown below, using
data from the Atmospheric Imaging Assembly (AIA,
\citealp{2012SoPh..275...17L}) on board the Solar Dynamics Observatory
(SDO, \citealp{2012SoPh..275....3P}), that time-series of coronal
emission may be better described by other models{\bf , based power-law
  power spectra that are actually observed} .  These models, {\bf
  based around \PL\ Fourier \PS}, have implications for the practice
of coronal seismology, and may be indicative of the nature of the
...
\startdata
$\ln(A)$ & $-10 \rightarrow \ln(10)$  & \\
$n$ & $1\rightarrow 6$ &   \\
$\ln(C)$ & $-20 \rightarrow 10$ & \\
$N_{eff}$ & {empirically determined}\tablenotemark{1} & \\
$\ln(\alpha)$  &  & $2.1 \times 10^{-9} \rightarrow 148$ \\
$\beta$ &  & $0.5 - 10$ (mHz)\tablenotemark{2}\\
$\log_{10}\delta$ &  & $0.001\rightarrow 3$ \\
\enddata
\tablenotetext{1}{See Figure \ref{???} and Equation \ref{eqn:neff}.}
\tablenotetext{2}{Model 2 for AIA 193\AA\ loop footpoint region required a uniform prior
