...
\documentclass[preprint]{../aastex52/aastex}
\usepackage{graphicx}
\usepackage{color}
\usepackage{multirow}
%\usepackage{showkeys}
...
\begin{figure}
\label{fig:fit171}
\plottwo{shutdownfun3_6hr_disk_1.5_171_loopfootpoints.hanning.relative.power_spectra_distributions.eps}{shutdownfun3_6hr_disk_1.5_171_loopfootpoints.hanning.relative.power_spectra_distributions.eps}
\plottwo{shutdownfun3_6hr_disk_1.5_171_loopfootpoints.hanning.relative.power_spectra_distributions.eps}{shutdownfun3_6hr_disk_1.5_171_loopfootpoints.hanning.relative.power_spectra_distributions.eps}
\caption{aaa}
\end{figure}
...
Figures \ref{fig:dist171} and \ref{fig:dist193} show that the
logarithm of the Fourier power in a region of the Sun may be
approximated by a normal distribution $N(\mu, \sigma)$.  The maximum
likelihood estimate of the mean and variance of normal distribution
are given by
\begin{equation}
