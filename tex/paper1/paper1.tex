...
\begin{figure}
\label{fig:geom171}
\plottwo{shutdownfun3_6hr_disk_1.5_171_loopfootpoints.hanning.relative.geometric_mean_power_spectra.eps}{shutdownfun3_6hr_disk_1.5_171_moss.hanning.relative.geometric_mean_power_spectra.eps}
\plottwo{shutdownfun3_6hr_disk_1.5_171_qs.hanning.relative.geometric_mean_power_spectra.eps}{shutdownfun3_6hr_disk_1.5_171_sunspot.hanning.relative.geometric_mean_power_spectra.eps}
\caption{}
\end{figure}

\begin{figure}
\label{fig:geom193}
\plottwo{shutdownfun3_6hr_disk_1.5_193_loopfootpoints.hanning.relative.geometric_mean_power_spectra.eps}{shutdownfun3_6hr_disk_1.5_193_moss.hanning.relative.geometric_mean_power_spectra.eps}
\plottwo{shutdownfun3_6hr_disk_1.5_193_qs.hanning.relative.geometric_mean_power_spectra.eps}{shutdownfun3_6hr_disk_1.5_193_sunspot.hanning.relative.geometric_mean_power_spectra.eps}
...
\begin{equation}
\label{eq:pwrlawbunp}
\ln P_{1}(f) = \ln P_{0} + \alpha\exp\left[-\frac{(\ln(f)-\beta)^{2}}{2\sigma^{2}}\right]
\end{equation}
...
pixels have power-law like power spectra.  This implications for the
design of automated oscillation detection algorithms.  Such an
...
\cite{2010SoPh..264..403I}.  Such approaches {\it may} have yet to be
tested assuming a red-noise background power spectrum, and so their
efficacy is unknown.

All the automated detection algorithms described above attempt to find
pixels that are obviously oscillating at some frequency.  Hence, the
strength of the oscillation at that frequency, compared to some
assumption of the background, is the key quantity to measure.
Detection algorithms based on wave coherence, such as
...
given frequency range.  The frequency range searched is based on
