...
\caption{Geometric mean of the \protect\Fpa\ (black solid line) in
  ...
  shown in green; the location of the maximum of the
  $G(\nu)/P_{1}(\nu)$ ratio is indicated by the green dotted line.
...
described in \ref{sec:app:ind}.  The position of $G(\nu)$ is
restricted by permitting $\beta$ to vary in the range $1-10$ mHz only.
This restriction, which is imposed in the fitting process (see Section
\ref{{sec:app:ind}), arises from the observations of significant
  wavelet power in the period rangs 200 - 600 seconds as found by
  \cite{2003ApJ...595L..63D}. 
...
$\beta$ & not applicable  & $1 - 10$ \\
$\delta$ & not applicable & $0.001\rightarrow 3$ \\
\enddata
\end{deluxetable}
...
Give an idea of how the errors are found 
