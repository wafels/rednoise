...
Secondly, since each loop is different, and the reaction of the
coronal plasma to an energy deposition event is a highly nonlinear
function of the coronal conditions it occurs in, 
