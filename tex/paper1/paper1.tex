...
loop footpoints & 171\AA  & $0.55^{+0.02}_{-0.02}$  & $2.28^{+0.02}_{-0.02}$  & $-4.26^{+0.00}_{-0.00}$  & $-2.34^{+0.07}_{-0.07}$ & $0.73^{+0.07}_{-0.06}$  & $0.32^{+0.01}_{-0.01}$  \\
                & 193\AA  & $0.21^{+0.02}_{-0.02}$  & $2.27^{+0.03}_{-0.03}$ & $-4.40^{+0.00}_{-0.00}$  & $-2.24^{+0.09}_{-0.10}$ & $0.37^{+0.06}_{-0.04}$  & $0.40^{+0.01}_{-0.02}$  \\
                & & & & & & & \\
...
$\beta$ & not applicable  & $0.5 - 10$\tablenote{???} (mHz)\\
$\delta$ & not applicable & $0.001\rightarrow 3$ (decades of frequency)\\
\enddata
\tablenote{???Model 2 for AIA 193\AA\ loop footpoint region required a uniform prior
