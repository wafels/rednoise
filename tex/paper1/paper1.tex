...
\begin{abstract}
  ...
  {\bf The dynamics of regions of the solar corona are investigated
    ...
    can be described by a power law at lower frequencies that tails to
...
{\bf Data from the Atmospheric Imaging Assembly (AIA,
  \citealp{2012SoPh..275...17L}) on board the Solar Dynamics
  Observatory (SDO, \citealp{2012SoPh..275....3P}) are used.}  AIA
observes images of the Sun in multiple wavebands simultaneously and
continuously, at high cadence (12 seconds) and at high spatial
resolution (0.6 arcseconds per pixel).  These data enable detailed
comparisons between phenomena observed in multiple wavebands, and are
therefore ideal for assessing the frequency content of the solar
atmosphere.  The data was acquired using the Lockheed Martin Solar
Astrophysics cutout service at
\href{http://lmsal.com/get\_aia\_data/}.  Six hours of image data in
the time range 2012-09-23 00:00 - 06:00 UT, at the full 12 second
cadence, in the 171\AA\ and 193\AA\ wavebands is used.  These
wavebands were selected because previous studies in similar wavebands
(TRACE 171\AA\ and 193\AA) show the presence of coronal oscillations.
{\bf The selected area covers a single $\beta\gamma$ active region,
  NOAA AR 11575}.  This area was selected for two reasons.  First, it
is quiescent in that there were no X-ray flares or other large-scale
...
regions do not.  However, it should be noted that there is no {\it a
  priori} reason why the power law indices for a region observed in two
