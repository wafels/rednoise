...
began in earnest with observations of wave modes by SOHO-EIT \citep{}
and TRACE \citep{} (see also \cite{} for more extensive reviews of
coronal seismology).  Since then, many papers have been published
describing oscillatory phenomena in the corona and their
...
extent of the loop \citep{valery}.  These motions appear to be
triggered by nearby flaring events, and are identified with the
...
Their relative scarcity has prompted efforts to create automated
