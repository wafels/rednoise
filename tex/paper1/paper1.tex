...
{\bf \cite{2004SoPh..223....1D, 2007SoPh..241..397N,
...
\ref{sec:introduction} have yet to be tested assuming a background
...
given frequency range.  Oscillations that are detected propagating
along loops are often found by considering distance-time plots
...
much reduced.  {\bf The wave coherence method of \cite{2008SoPh..252..321M}
uses a symmetric filter to estimate the coherence, in that oscillatory
power from either side of the central search frequency contributes the
same weight to the final result.  The effect of this filter in the
presence of a \PL\ \PS\ may be to bias detections to lower
frequencies.}
