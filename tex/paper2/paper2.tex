...
Models are fit by first generating an estimate of the model
parameters.  This estimate is used as an initial guess to a fitting
routine.  Models were fit by varying model parameters to find the
maximum of the log of likelihood of the data given the model.  The
